import 'package:time_catcher/APICallers/UserApiCaller.dart';
import 'package:time_catcher/CustomWidgets/CustomButtonLoading.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<dynamic> onSubmit(context) async {
    ...
    Map<String, dynamic> status = await userApiCaller.login(email, password, fcmToken);
    changeLoadingState();
    if (status['Err_Flag']) {
      setState(() {
