...
import 'package:time_catcher/Helpers/DataMapper.dart';
import 'package:time_catcher/Helpers/ResponseHandler.dart';
...
class UserApiCaller {
  ...
  Future<Map<String, dynamic>> login(String? email, String? password, String? fcmToken) async {
    ...
    var body = {"email": email, "password": password, "app": "TimeCatcher", "fcmToken": fcmToken};
    try {
